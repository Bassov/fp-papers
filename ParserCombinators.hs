...
{-|
  Implemented accroding to:
  Monadic Parsing in Haskell
  By: Graham Hutton, Erik Meijer
  Link: https://goo.gl/A89MjJ

  There is also a paper which describes this approach in depth
  Monadic Parser Combinators by Graham Hutton, Erik Meijer
  Link: http://eprints.nottingham.ac.uk/237/
-}
...
-- **********************************************************
--           EXAMPLE
-- Parser for Lambda-calculus grammar in Krivine notation
-- **********************************************************
